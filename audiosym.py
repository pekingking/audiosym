        ...
        if os.path.exists(directory):
            ...
            for dirname, dirnames, filenames in os.walk("./"):
                ...
                for filename in filenames:
                    if fnmatch.fnmatch(os.path.join(dirname, filename).lstrip("./").lower(), "*.mp3") or fnmatch.fnmatch(os.path.join(dirname, filename).lstrip("./").lower(), "*.m3a") or fnmatch.fnmatch(os.path.join(dirname, filename).lstrip("./").lower(), "*.m4b") or fnmatch.fnmatch(os.path.join(dirname, filename).lstrip("./").lower(), "*.acc"):
